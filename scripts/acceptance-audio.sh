...
[ -n "$RELAY" ] && ok "relay hub bound (udp/$RELAY)" || note "no relay socket yet -- the driver will ask the server once it has created the source (see driverlib.ResolveRelayPort)"
