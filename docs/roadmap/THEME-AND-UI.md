...
**Status: PLANNED for v0.5.0.** (Moved from v0.4.0, which shipped on
2026-08-07 without it — the number named what was released rather than what had
been earmarked. Nothing about the scope below changed.) Researched 2026-08-04 against real product
