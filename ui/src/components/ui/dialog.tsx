  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-h-[90vh] overflow-y-auto rounded-lg border border-border-strong bg-popover p-4 shadow-2xl",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("text-sm font-semibold tracking-tight", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn("text-[11px] text-muted-foreground", className)} {...props} />
));
