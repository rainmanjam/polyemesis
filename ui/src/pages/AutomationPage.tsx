...
/* ------------------------------------------------------------------ client
 *
 * The automation endpoints are typed and called here rather than from
 * lib/api.ts because that module belongs to another workstream this cycle.
 * Everything below the divider is ordinary page code; this block is the only
 * part that should eventually move.
 */
